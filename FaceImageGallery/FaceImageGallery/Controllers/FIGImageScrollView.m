...
@interface FIGImageScrollView () <UIScrollViewDelegate>
...
@implementation FIGImageScrollView
...
- (void)setIndex:(NSUInteger)index {
    ...
    _index = index;
    UIImage *image = [[FIGPhotoDetailViewControllerData sharedInstance] photoAtIndex:index];
    [self displayImage:image];
}

+ (NSUInteger)imageCount {
    
    return [[FIGPhotoDetailViewControllerData sharedInstance] photoCount];
}
